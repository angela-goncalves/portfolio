...
export default function Card({ title, description, image, href }) {
    return (
        <a href={href}><div className="z-0 project-tile flex flex-col items-center m-6 p-6 rounded-2xl bg-card transition-shadow duration-600 ease-in-out transform hover:scale-105">
